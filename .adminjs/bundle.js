(function (React, designSystem, adminjs) {
  ...
  const ApproveMember = props => {
    ...
    const handleSubmit = event => {
      ...
      axios.post(`${api_url}/admin/api/resources/${resource.id}/records/${record?.params._id}/edit`, formData).then(res => {
